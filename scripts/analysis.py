...
plots.plot_worst_simulation(price_simulations_B, returns_distribution = 'normal', point_evaluate_eth_price = POINT_EVALUATE_ETH_PRICE, correlation = str(0.1))

#Normally distributed, -0.9 correlation
# price_simulations = simulation.multivariate_monte_carlo(close_prices = close_prices, returns_distribution = 'normal', num_simulations = NUM_SIMULATIONS, T = DAYS_AHEAD, dt = TIME_INCREMENT, correlation = -0.9, res_vol = 0.5, collateral_asset = COLLATERAL_ASSET)
plots.plot_worst_simulation(price_simulations_C, returns_distribution = 'normal', point_evaluate_eth_price = POINT_EVALUATE_ETH_PRICE, correlation = str(-0.9))
...
for i in range(13, 101):
    plots.plot_crash_sims(debt_levels = DEBTS, liquidity_levels = LIQUIDITIES, price_simulations = price_simulations_A, initial_eth_vol = INITIAL_ETH_VOL, point_evaluate_eth_price = i, returns_distribution = returns_distribution, correlation = str(correlation))

correlation = 0.1
returns_distribution = 'normal'
# price_simulations = simulation.multivariate_monte_carlo(close_prices = close_prices, returns_distribution = returns_distribution, num_simulations = NUM_SIMULATIONS, T = DAYS_AHEAD, dt = TIME_INCREMENT, correlation = correlation, res_vol = 0.5, collateral_asset = COLLATERAL_ASSET)
plots.plot_crash_sims(debt_levels = DEBTS, liquidity_levels = LIQUIDITIES, price_simulations = price_simulations_B, initial_eth_vol = INITIAL_ETH_VOL, point_evaluate_eth_price = POINT_EVALUATE_ETH_PRICE, returns_distribution = returns_distribution, correlation = str(correlation))

correlation = -0.9
returns_distribution = 'normal'
# price_simulations = simulation.multivariate_monte_carlo(close_prices = close_prices, returns_distribution = returns_distribution, num_simulations = NUM_SIMULATIONS, T = DAYS_AHEAD, dt = TIME_INCREMENT, correlation = correlation, res_vol = 0.5, collateral_asset = COLLATERAL_ASSET)
plots.plot_crash_sims(debt_levels = DEBTS, liquidity_levels = LIQUIDITIES, price_simulations = price_simulations_C, initial_eth_vol = INITIAL_ETH_VOL, point_evaluate_eth_price = POINT_EVALUATE_ETH_PRICE, returns_distribution = returns_distribution, correlation = str(correlation))

#7. Plot heatmap for debt vs liquidity dry-up
price_simulations = simulation.multivariate_monte_carlo(close_prices = close_prices, returns_distribution = returns_distribution, num_simulations = NUM_SIMULATIONS, T = DAYS_AHEAD, dt = TIME_INCREMENT, correlation =0.9,  res_vol = 0.5, collateral_asset = COLLATERAL_ASSET)
...
plots.plot_heatmap_liquidities(debt_levels = debts, liquidity_params = liquidities, price_simulations = price_simulations_A, initial_eth_vol = INITIAL_ETH_VOL, point_evaluate_eth_price = POINT_EVALUATE_ETH_PRICE)
